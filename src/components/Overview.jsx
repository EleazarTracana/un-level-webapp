...
const Overview = () => {
  return (
    <section id="overview" className={`flex md:flex-row flex-col ${styles.paddingY} px-3 lg:px-16 sm:px-4`}>
      <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 lg:px-0 sm:px-2 px-2`}>
